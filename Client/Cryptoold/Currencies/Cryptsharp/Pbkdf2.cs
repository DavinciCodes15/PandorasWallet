...
using Pandora.Client.Crypto.Currencies.BouncyCastle.Crypto;
...
namespace Pandora.Client.Crypto.Currencies.Crypto
{
    ...
    public class Pbkdf2 : Stream
    {
		...
		{
			Pandora.Client.Crypto.Currencies.Crypto.Internal.Check.Null("hmacAlgorithm", hmacAlgorithm);
			Pandora.Client.Crypto.Currencies.Crypto.Internal.Check.Null("salt", salt);
			Pandora.Client.Crypto.Currencies.Crypto.Internal.Check.Length("salt", salt, 0, int.MaxValue - 4);
			Pandora.Client.Crypto.Currencies.Crypto.Internal.Check.Range("iterations", iterations, 1, int.MaxValue);
        ...
        {
            Pandora.Client.Crypto.Currencies.Crypto.Internal.Check.Range("count", count, 0, int.MaxValue);
		...
		{
			Pandora.Client.Crypto.Currencies.Crypto.Internal.Check.Range("derivedKeyLength", derivedKeyLength, 0, int.MaxValue);
        ...
        {
            Pandora.Client.Crypto.Currencies.Crypto.Internal.Check.Bounds("buffer", buffer, offset, count);
            int bytes = 0;
