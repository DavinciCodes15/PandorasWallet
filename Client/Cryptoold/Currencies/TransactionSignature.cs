...
namespace Pandora.Client.Crypto.Currencies
{
	...
	{
		static readonly TransactionSignature _Empty = new TransactionSignature(new ECDSASignature(Pandora.Client.Crypto.Currencies.BouncyCastle.Math.BigInteger.ValueOf(0), Pandora.Client.Crypto.Currencies.BouncyCastle.Math.BigInteger.ValueOf(0)), SigHash.All);
