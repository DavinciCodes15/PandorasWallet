...
namespace Pandora.Client.Crypto.Currencies
{
    public abstract class Network
    {
        ...
        //public Network Main { get { return Networks[MainNet]; } }
        //public Network Test { get { return Networks[TestNet]; } }

        protected byte[][] base58Prefixes = new byte[20][];
        protected Bech32Encoder[] bech32Encoders = new Bech32Encoder[2];

        protected Network[] FNetworks;

        public abstract Network[] Networks { get; }

        protected abstract void InitMainNet();

        protected abstract void InitTestNet();
