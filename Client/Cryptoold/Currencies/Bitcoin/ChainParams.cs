...
namespace Pandora.Client.Crypto.Currencies
{
    ...
    //public class ServerChainParamsList : Dictionary<uint, ServerChainParams>
    //{
    //    private ServerChainParamsList() : base()
    //    {
    //        Add(1, new ServerChainParams()
    //        {
    //            NetworkName = "Bitcoin",
    //            Network = 0,
    //            PublicKeyAddress = new byte[] { (0) },
    ...
    //        }
    //        );
    //        Add(10001, new ServerChainParams()
    //        {
    //            NetworkName = "Bitcoin",
    //            Network = 1,
    //            PublicKeyAddress = new byte[] { (111) },
    ...
    //            Network = 0,
    //            PublicKeyAddress = new byte[] { (48) },
    //            ScriptAddress = new byte[] { (50) },
    //            SecretKey = new byte[] { (176) },
    //            ExtPublicKey = new byte[] { (0x04), (0x88), (0xB2), (0x1E) },
    //            ExtSecretKey = new byte[] { (0x04), (0x88), (0xAD), (0xE4) },
    //            ForkFromId = 0
    //        }
    ...
    //    static ServerChainParamsList FList = new ServerChainParamsList();

    //    public static ServerChainParamsList GetInstance()
    //    {
    //        return FList;
    //    }
    //}
