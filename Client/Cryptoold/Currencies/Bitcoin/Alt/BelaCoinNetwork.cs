...
{
    public class BelaCoinNetwork : BitcoinNetwork
    {
        protected BelaCoinNetwork(int aNet)
            : base(aNet)
        {
        }
        ...
        public new static BelaCoinNetwork GetMainNet()
        {
            return GetNetworks()[MainNet];
        }

        private static List<BelaCoinNetwork> FNetworks;

        public new static BelaCoinNetwork[] GetNetworks()
        {
            if (FNetworks == null)
            {

                FNetworks = new List<BelaCoinNetwork>();

                FNetworks.Add(new BelaCoinNetwork(Network.MainNet));
                FNetworks.Add(new BelaCoinNetwork(Network.TestNet));
            }
