...
{
    public class BitcoinCashNetwork : BitcoinNetwork
    {
        protected BitcoinCashNetwork(int aNet)
            : base(aNet)
        {
        }
        ...
        {
            get { return "BitcoinCash"; }
        }

        public new static BitcoinCashNetwork GetMainNet()
        {
            return GetNetworks()[MainNet];
        }

        private static List<BitcoinCashNetwork> FNetworks;

        public new static BitcoinCashNetwork[] GetNetworks()
        {
            if (FNetworks == null)
            {

                FNetworks = new List<BitcoinCashNetwork>();

                FNetworks.Add(new BitcoinCashNetwork(Network.MainNet));
                FNetworks.Add(new BitcoinCashNetwork(Network.TestNet));
            }
