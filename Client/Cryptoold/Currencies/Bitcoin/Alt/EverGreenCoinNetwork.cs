...
{
    public class EverGreenCoinNetwork : BitcoinNetwork
    {
        protected EverGreenCoinNetwork(int aNet)
            : base(aNet)
        {
        }
        ...
        {
            get { return "EverGreenCoin"; }
        }

        public new static EverGreenCoinNetwork GetMainNet()
        {
            return GetNetworks()[MainNet];
        }

        private static List<EverGreenCoinNetwork> FNetworks;

        public new static EverGreenCoinNetwork[] GetNetworks()
        {
            if (FNetworks == null)
            {

                FNetworks = new List<EverGreenCoinNetwork>();

                FNetworks.Add(new EverGreenCoinNetwork(Network.MainNet));
                FNetworks.Add(new EverGreenCoinNetwork(Network.TestNet));
            }
