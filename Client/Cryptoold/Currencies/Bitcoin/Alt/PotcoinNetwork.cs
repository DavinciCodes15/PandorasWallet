...
{
    public class PotcoinNetwork : BitcoinNetwork
    {
        protected PotcoinNetwork(int aNet)
            : base(aNet)
        {
        }
        ...
        public new static PotcoinNetwork GetMainNet()
        {
            return GetNetworks()[MainNet];
        }

        private static List<PotcoinNetwork> FNetworks;

        public new static PotcoinNetwork[] GetNetworks()
        {
            if (FNetworks == null)
            {

                FNetworks = new List<PotcoinNetwork>();

                FNetworks.Add(new PotcoinNetwork(Network.MainNet));
                FNetworks.Add(new PotcoinNetwork(Network.TestNet));
            }
