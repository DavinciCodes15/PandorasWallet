...
{
    public class HoboNickelsNetwork : BitcoinNetwork
    {
        protected HoboNickelsNetwork(int aNet)
            : base(aNet)
        {
        }
        ...
        {
            get { return "HoboNickels"; }
        }

        public new static HoboNickelsNetwork GetMainNet()
        {
            return GetNetworks()[MainNet];
        }

        private static List<HoboNickelsNetwork> FNetworks;

        public new static HoboNickelsNetwork[] GetNetworks()
        {
            if (FNetworks == null)
            {

                FNetworks = new List<HoboNickelsNetwork>();

                FNetworks.Add(new HoboNickelsNetwork(Network.MainNet));
                FNetworks.Add(new HoboNickelsNetwork(Network.TestNet));
            }
        ...
        protected override void InitMainNet()
        {
            ...
            SetBase58Prefixes(Base58Type.SECRET_KEY, new byte[] { (162) });
