...
{
    public class LitecoinNetwork : BitcoinNetwork
    {
        protected LitecoinNetwork(int aNet)
            : base(aNet)
        {
        }
        ...
        public new static LitecoinNetwork GetMainNet()
        {
            return GetNetworks()[MainNet];
        }

        private static List<LitecoinNetwork> FNetworks;

        public new static LitecoinNetwork[] GetNetworks()
        {
            if (FNetworks == null)
            {

                FNetworks = new List<LitecoinNetwork>();

                FNetworks.Add(new LitecoinNetwork(Network.MainNet));
                FNetworks.Add(new LitecoinNetwork(Network.TestNet));
            }
        ...
        protected override void InitMainNet()
        {
            ...
            SetBase58Prefixes(Base58Type.SCRIPT_ADDRESS, new byte[] { (50) });
        ...
        protected override void InitTestNet()
        {
            ...
            SetBase58Prefixes(Base58Type.SCRIPT_ADDRESS, new byte[] { (58) });
