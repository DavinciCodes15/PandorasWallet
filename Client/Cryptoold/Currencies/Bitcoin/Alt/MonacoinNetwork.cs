...
{
    public class MonacoinNetwork : BitcoinNetwork
    {
        protected MonacoinNetwork(int aNet)
            : base(aNet)
        {
        }
        ...
        public new static MonacoinNetwork GetMainNet()
        {
            return GetNetworks()[MainNet];
        }

        private static List<MonacoinNetwork> FNetworks;

        public new static MonacoinNetwork[] GetNetworks()
        {
            if (FNetworks == null)
            {

                FNetworks = new List<MonacoinNetwork>();

                FNetworks.Add(new MonacoinNetwork(Network.MainNet));
                FNetworks.Add(new MonacoinNetwork(Network.TestNet));
            }
