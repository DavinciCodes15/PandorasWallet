...
using Builder = System.Func<Pandora.Client.Crypto.Currencies.TransactionBuilder.TransactionBuildingContext, Pandora.Client.Crypto.Currencies.IMoney>;
    ...
    public class TransactionBuilder
    {
        ...
        internal class TransactionBuildingContext
        {
            ...
            public void RestoreMemento(TransactionBuildingContext memento)
            {
                ...
                Transaction = memento.Transaction.Clone(false);
        ...
        /// </summary>
        public Func<Script, CCKey> KeyFinder
        {
            get;
            set;
        }
        ...
        //public TransactionBuilder Send(BitcoinStealthAddress address, Money amount, CCKey ephemKey = null)
        //{
        //    if (amount < Money.Zero)
        //        throw new ArgumentOutOfRangeException("amount", "amount can't be negative");
        ...
        //    Transaction tx = transactions[0].Clone(false);
