...
namespace Pandora.Client.Crypto.Currencies
{
    public class uint256
    {
        ...
        public readonly UInt32 pn0;
        public readonly UInt32 pn1;
        public readonly UInt32 pn2;
        public readonly UInt32 pn3;
        public readonly UInt32 pn4;
        public readonly UInt32 pn5;
        public readonly UInt32 pn6;
        public readonly UInt32 pn7;
        ...
        public MutableUint256 AsCoinSerializable()
        {
            return new MutableUint256(this);
        }

        public int GetSerializeSize()//int nType=0, int protocolVersion = 0)
        {
            return WIDTH_BYTE;
        }
    ...
    public class uint160
    {
        ...
        public MutableUint160 AsCoinSerializable()
        {
