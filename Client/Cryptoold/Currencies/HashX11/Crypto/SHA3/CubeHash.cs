...
namespace Pandora.Client.Crypto.Currencies.HashX11.Crypto.SHA3
{
    ...
    internal abstract class CubeHash : BlockHash, ICryptoNotBuildIn
    {
        ...
        static CubeHash()
        {
            ...
            {
                CubeHash ch = (CubeHash)HashFactory.Crypto.SHA3.CreateCubeHash(Pandora.Client.Crypto.Currencies.HashX11.HashSize.HashSize256);
        ...
        public CubeHash(Pandora.Client.Crypto.Currencies.HashX11.HashSize a_hash_size)
