...
namespace Pandora.Client.Crypto.Currencies.HashX11.Crypto.SHA3.Custom
{
    ...
    //{
    //    public SHAvite3_224()
    //        : base(Pandora.Client.Crypto.Currencies.HashX11.HashSize.HashSize224)
    //    {
    //    }
    //}
    ...
    //{
    //    public SHAvite3_256()
    //        : base(Pandora.Client.Crypto.Currencies.HashX11.HashSize.HashSize256)
    //    {
    //    }
    //}
    ...
    {
        public SHAvite3_384()
            : base(Pandora.Client.Crypto.Currencies.HashX11.HashSize.HashSize384)
        {
        }
    }
    ...
    {
        public SHAvite3_512()
            : base(Pandora.Client.Crypto.Currencies.HashX11.HashSize.HashSize512)
        {
        }
    }
    ...
    internal abstract class SHAvite3Base : BlockHash, ICryptoNotBuildIn
    {
        ...
        public SHAvite3Base(Pandora.Client.Crypto.Currencies.HashX11.HashSize a_hash_size, int a_block_size)
    ...
    //    public SHAvite3_256Base(Pandora.Client.Crypto.Currencies.HashX11.HashSize a_hash_size)
    //        : base(a_hash_size, 64)
    //    {
    //        Initialize();
    //    }
    ...
    internal abstract class SHAvite3_512Base : SHAvite3Base
    {
        ...
        public SHAvite3_512Base(Pandora.Client.Crypto.Currencies.HashX11.HashSize a_hash_size)
