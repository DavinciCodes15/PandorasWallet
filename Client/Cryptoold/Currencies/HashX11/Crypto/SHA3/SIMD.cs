...
namespace Pandora.Client.Crypto.Currencies.HashX11.Crypto.SHA3
{
    ...
    internal abstract class SIMDBase : BlockHash, ICryptoNotBuildIn
    {
        ...
        public SIMDBase(Pandora.Client.Crypto.Currencies.HashX11.HashSize a_hash_size, int a_block_size)
    ...
    internal abstract class SIMD256Base : SIMDBase
    {
        ...
        public SIMD256Base(Pandora.Client.Crypto.Currencies.HashX11.HashSize a_hash_size)
            : base(a_hash_size, 64)
        {
        }
    ...
    internal abstract class SIMD512Base : SIMDBase
    {
        ...
        public SIMD512Base(Pandora.Client.Crypto.Currencies.HashX11.HashSize a_hash_size)
