...
namespace Pandora.Client.Crypto.Currencies
{
    public abstract class TxDestination : IDestination
	{
		...
		public abstract CoinAddress GetAddress(Network network);
    ...
    public class KeyId : TxDestination
	{
		...
		public override CoinAddress GetAddress(Network network)
		{
			return new CoinPubKeyAddress(this, network);
		}
	}
    ...
    public class WitKeyId : TxDestination
	{
		...
		public override CoinAddress GetAddress(Network network)
		{
			return new CoinWitPubKeyAddress(this, network);
		}
	}
    ...
    public class WitScriptId : TxDestination
	{
		...
		public override CoinAddress GetAddress(Network network)
		{
			return new CoinWitScriptAddress(this, network);
		}
	}
	...
	public class ScriptId : TxDestination
	{
		...
		public override CoinAddress GetAddress(Network network)
		{
			return new CoinScriptAddress(this, network);
		}
	}
}
