using Pandora.Client.Crypto.Currencies.BouncyCastle.Asn1.X9;
using Pandora.Client.Crypto.Currencies.BouncyCastle.Crypto.Parameters;
using Pandora.Client.Crypto.Currencies.BouncyCastle.Crypto.Signers;
using Pandora.Client.Crypto.Currencies.BouncyCastle.Math;
using Pandora.Client.Crypto.Currencies.BouncyCastle.Math.EC;
using System;
using Pandora.Client.Crypto.Currencies.BouncyCastle.Math.EC.Custom.Sec;
...
namespace Pandora.Client.Crypto.Currencies.Crypto
{
	internal class ECKey
	{
		...
		static ECKey()
		{
            _Secp256k1 = Pandora.Client.Crypto.Currencies.BouncyCastle.Crypto.EC.CustomNamedCurves.Secp256k1;
		...
		{
			if(isPrivate)
                _Key = new ECPrivateKeyParameters(new Pandora.Client.Crypto.Currencies.BouncyCastle.Math.BigInteger(1, vch), DomainParameter);
			else
			{
		...
		public static ECKey RecoverFromSignature(int recId, ECDSASignature sig, uint256 message, bool compressed)
		{
			...
			var n = curve.N;
            var i = Pandora.Client.Crypto.Currencies.BouncyCastle.Math.BigInteger.ValueOf((long)recId / 2);
            ...
            var e = new Pandora.Client.Crypto.Currencies.BouncyCastle.Math.BigInteger(1, message.ToBytes());
            ...
            var eInv = Pandora.Client.Crypto.Currencies.BouncyCastle.Math.BigInteger.Zero.Subtract(e).Mod(n);
        ...
        private static ECPoint DecompressKey(Pandora.Client.Crypto.Currencies.BouncyCastle.Math.BigInteger xBN, bool yBit)
		{
