...
namespace Pandora.Client.Crypto.Currencies
{
	...
	public class PayToScriptHashTemplate : ScriptTemplate
	{
        ...
        public Script GenerateScriptSig(Crypto.ECDSASignature[] signatures, Script redeemScript)
        {
	...
	public class PayToPubkeyTemplate : ScriptTemplate
	{
        ...
        public Script GenerateScriptSig(Crypto.ECDSASignature signature)
        {
    ...
    public class PayToPubkeyHashTemplate : ScriptTemplate
	{
		...
		public Script GenerateScriptPubKey(CoinPubKeyAddress address)
		{
			if(address == null)
    ...
    public class PayToWitScriptHashTemplate : PayToWitTemplate
	{
		...
		public Script GenerateScriptPubKey(CoinWitScriptAddress address)
		{
			if(address == null)
				throw new ArgumentNullException("address");
			return GenerateScriptPubKey(address.Hash);
