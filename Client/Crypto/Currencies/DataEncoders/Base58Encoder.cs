...
namespace Pandora.Client.Crypto.Currencies.DataEncoders
{
	public class Base58CheckEncoder : Base58Encoder
	{
        ...
        public virtual bool IsValidData(string aEncoded)
        {
            if (aEncoded == null) return false;
            var vchRet = InternalEncoder.DecodeData(aEncoded);
            if (vchRet.Length < 4)
                return false;
            ...
            return Utils.ArrayEqual(calculatedHash, expectedHash);
        }
