...
namespace Pandora.Client.Crypto.Currencies.HashX11.Crypto.SHA3
{
    ...
    {
        public Skein256Base(Pandora.Client.Crypto.Currencies.HashX11.HashSize a_hash_size)
            : base(a_hash_size, 32)
        {
        }
    ...
    {
        public Skein512Base(Pandora.Client.Crypto.Currencies.HashX11.HashSize a_hash_size)
            : base(a_hash_size, 64)
        {
        }
    ...
    internal abstract class SkeinBase : BlockHash, ICryptoNotBuildIn
    {
        ...
        public SkeinBase(Pandora.Client.Crypto.Currencies.HashX11.HashSize a_hash_size, int a_block_size)
