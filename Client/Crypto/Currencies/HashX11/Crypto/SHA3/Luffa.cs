...
namespace Pandora.Client.Crypto.Currencies.HashX11.Crypto.SHA3
{
    internal abstract class LuffaBase : BlockHash, ICryptoNotBuildIn
    {
        ...
        public LuffaBase(Pandora.Client.Crypto.Currencies.HashX11.HashSize a_hash_size)
    ...
    {
        public Luffa256Base(Pandora.Client.Crypto.Currencies.HashX11.HashSize a_hash_size)
            : base(a_hash_size)
        {
            m_result_blocks = 3;
            m_iv_length = 24;
