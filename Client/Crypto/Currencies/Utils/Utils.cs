...
namespace Pandora.Client.Crypto.Currencies
{
    public static class Extensions
    {
        ...
        public static T ToNetwork<T>(this T obj, Network network) where T : ICryptoCurrencyString
        {
            ...
            //	return obj;
            //if(obj is IBinaryEncodable)
            //{
            //	var b58 = (IBinaryEncodable)obj;
            ...
            //             //else
            //             //{
            //             //    var colored = CoinColoredAddress.GetWrappedBase58(obj.ToString(), obj.Network);
            //             //    var address = Network.Parse<CoinAddress>(colored, obj.Network).ToNetwork(network);
    ...
    public class Utils
    {
        ...
        public static String COIN_SIGNED_MESSAGE_HEADER = "Coin Signed Message:\n";
        public static byte[] COIN_SIGNED_MESSAGE_HEADER_BYTES = Encoding.UTF8.GetBytes(COIN_SIGNED_MESSAGE_HEADER);

        public static byte[] FormatMessageForSigning(byte[] messageBytes)
        {
            MemoryStream ms = new MemoryStream();

            ms.WriteByte((byte)COIN_SIGNED_MESSAGE_HEADER_BYTES.Length);
            Write(ms, COIN_SIGNED_MESSAGE_HEADER_BYTES);
        ...
        public static Array BigIntegerToBytes(Pandora.Client.Crypto.Currencies.BouncyCastle.Math.BigInteger b, int numBytes)
        {
            if (b == null)
            {
                return null;
        ...
        private static readonly TraceSource _TraceSource = new TraceSource("Pandora.Client.Crypto.Currencies");
        ...
        public static ulong DateTimeToUnixTimeLong(DateTimeOffset dt)
        {
