...
namespace Pandora.Client.Crypto.Currencies
{
    ...
    public class ScriptEvaluationContext
    {
        ...
        public ScriptEvaluationContext(Network aNetwork)
        {
...
0xDF,0xE9,0x2F,0x46,0x68,0x1B,0x20,0xA0
        ...
        bool CheckSig(byte[] vchSig, byte[] vchPubKey, Script scriptCode, TransactionChecker checker, int sigversion)
        {
            ...
            uint256 sighash = Script.SignatureHash(Network, scriptCode, checker.Transaction, checker.Index, scriptSig.SigHash, checker.Amount, (HashVersion)sigversion, checker.PrecomputedTransactionData);
        ...
        {
            if (SigHash == Pandora.Client.Crypto.Currencies.SigHash.Undefined)
                return true;
