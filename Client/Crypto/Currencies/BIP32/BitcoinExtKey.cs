	...
	public class BitcoinExtKey : BitcoinExtKeyBase, ISecret, IHDKey
	{
		...
		public ExtKey ExtKey
		{
			get
			{
				...
				{
					_Key = new ExtKey();
					_Key.ReadWrite(new CoinStream(vchData));
				}
				return _Key;
			}
		}
		...
		public override Base58Type Type
		{
			get
			{
				return Network.BASE58_EXT_SECRET_KEY;
			}
		}
	...
	public class BitcoinExtPubKey : BitcoinExtKeyBase, IHDKey
	{
		...
		public ExtPubKey ExtPubKey
		{
			get
			{
				if (_PubKey == null)
				{
					_PubKey = new ExtPubKey(new CoinStream(vchData));
				}
				return _PubKey;
			}
		}
		...
		protected override bool IsValid
		{
			get
			{
				...
				{
					_PubKey = new ExtPubKey(new CoinStream(vchData));
					_PubKey.ReadWrite(new CoinStream(vchData));
					return true;
				}
				catch { return false; }
			}
		...
		public override Base58Type Type
		{
			get
			{
				return Network.BASE58_EXT_PUBLIC_KEY;
			}
		}
