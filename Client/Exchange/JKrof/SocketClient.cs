...
namespace Pandora.Client.Exchange.JKrof
{
    ...
    public abstract class SocketClient: BaseClient, ISocketClient
    {
        ...
        /// </summary>
        internal ConcurrentDictionary<int, SocketConnection> sockets = new ConcurrentDictionary<int, SocketConnection>();
        /// <summary>
        /// </summary>
        ...
        /// </summary>
        internal bool ContinueOnQueryResponse { get; set; }
        #endregion
        ...
        /// <returns></returns>
        internal virtual async Task<CallResult<bool>> SubscribeAndWait(SocketConnection socket, object request, SocketSubscription subscription)
        {
        ...
        protected  abstract bool HandleQueryResponse<T>(SocketConnection s, object request, JToken data, [NotNullWhen(true)]out CallResult<T> callResult);
        /// <summary>
        ...
        protected  abstract bool HandleSubscriptionResponse(SocketConnection s, SocketSubscription subscription, object request, JToken message, out CallResult<object> callResult);
        /// <summary>
        ...
        /// <returns></returns>
        internal  abstract bool MessageMatchesHandler(JToken message, object request);
        /// <summary>
        ...
        /// <returns></returns>
        protected abstract bool MessageMatchesHandler(JToken message, string identifier);
        /// <summary>
        /// Needs to authenticate the socket so authenticated queries/subscriptions can be made on this socket connection
        /// </summary>
        /// <param name="s"></param>
        /// <returns></returns>
        internal abstract Task<CallResult<bool>> AuthenticateSocket(SocketConnection s);
        /// <summary>
        ...
        /// <returns></returns>
        internal abstract Task<bool> Unsubscribe(SocketConnection connection, SocketSubscription s);
        ...
        /// <returns></returns>
        internal virtual JToken ProcessTokenData(JToken message)
        {
            return message;
        }
